...
create table orders (order_id bigint not null auto_increment, address varchar(255) not null, document_number varchar(255) not null, document_type varchar(255) not null, order_number varchar(255) not null, placement_date date not null, car_id bigint, sale_id integer, user_id bigint, primary key (order_id));
